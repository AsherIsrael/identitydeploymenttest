        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_messages_AspNetUsers_TestUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestUserId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shoppingcarts_AspNetUsers_TestUserId1",
                        column: x => x.TestUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_comments_AspNetUsers_TestUserId",
                        column: x => x.TestUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_comments_TestUserId",
                table: "comments",
                column: "TestUserId");

            migrationBuilder.CreateIndex(
                name: "IX_messages_TestUserId",
                table: "messages",
                column: "TestUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shoppingcarts_TestUserId1",
                table: "Shoppingcarts",
                column: "TestUserId1");
